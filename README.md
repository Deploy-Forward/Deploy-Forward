...
```sh
npx --yes deploy-forward@0.26.1 usage    # per-model table, vendor limit lanes, api-equivalent spend
npx --yes deploy-forward@0.26.1 serve    # the same view as a local web page at 127.0.0.1:4780
```
...
step: run `npx --yes deploy-forward@0.26.1` bare and it will show you the capture
